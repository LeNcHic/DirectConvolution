      ...
      for (int m = 0; m < kernel_width; ++m) {
        for (int i = 0; i < input_channels; ++i) {
          for (int k = 0; k < out_width; ++k) {
            ...
            kernel_ptr = &kernel[n * (kernel_width * input_channels * output_channels) + m * (input_channels * output_channels) + i * output_channels];
            result_ptr = &result[l * out_width * output_channels + k * output_channels];
            for (int j = 0; j < output_channels; j += 8, kernel_ptr += 8, result_ptr += 8) {
              kernel_data = vld1q_f32_x2(kernel_ptr);
              result_buffer = vld1q_f32_x2(result_ptr);
...
void loop_order_n1_tiled_channels(
  real32_t *result,
  const real32_t *image, const real32_t *kernel,
  int input_height, int input_width, int input_channels,
  int stride_height, int stride_width, int output_channels,
  int kernel_height, int kernel_width, int tile_size_input_channels) {
...
void loop_order_n1_tiled_width(
  real32_t *result,
  const real32_t *image, const real32_t *kernel,
  int input_height, int input_width, int input_channels,
  int stride_height, int stride_width, int output_channels,
  int kernel_height, int kernel_width, int tile_size_out_width) {
...
void loop_order_n2_tiled_width(
  real32_t *result,
  const real32_t *image, const real32_t *kernel,
  int input_height, int input_width, int input_channels,
  int stride_height, int stride_width, int output_channels,
...
void loop_order_n2_tiled_height(
  real32_t *result,
  const real32_t *image, const real32_t *kernel,
  int input_height, int input_width, int input_channels,
  int stride_height, int stride_width, int output_channels,
  int kernel_height, int kernel_width, int tile_size_out_height) {
...
void loop_order_n3_tiled_channels(
  real32_t *result,
  const real32_t *image, const real32_t *kernel,
  int input_height, int input_width, int input_channels,
  int stride_height, int stride_width, int output_channels,
...
void loop_order_n3_tiled_width(
  real32_t *result,
  const real32_t *image, const real32_t *kernel,
  int input_height, int input_width, int input_channels,
  int stride_height, int stride_width, int output_channels,
...
void loop_order_n1_tiled_channels_simd(
  real32_t *result,
  const real32_t *image, const real32_t *kernel,
  int input_height, int input_width, int input_channels,
  int stride_height, int stride_width, int output_channels,
...
void loop_order_n1_tiled_width_simd(
  real32_t *result,
  const real32_t *image, const real32_t *kernel,
  int input_height, int input_width, int input_channels,
  int stride_height, int stride_width, int output_channels,
...
void loop_order_n3_tiled_width_simd(
  real32_t *result,
  const real32_t *image, const real32_t *kernel,
  int input_height, int input_width, int input_channels,
  int stride_height, int stride_width, int output_channels,
...
void loop_order_n3_tiled_channels_simd(
  real32_t *result,
  const real32_t *image, const real32_t *kernel,
  int input_height, int input_width, int input_channels,
  int stride_height, int stride_width, int output_channels,
...
void loop_order_n2_tiled_width_simd(
  real32_t *result,
  const real32_t *image, const real32_t *kernel,
  int input_height, int input_width, int input_channels,
  int stride_height, int stride_width, int output_channels,
...
void loop_order_n2_tiled_height_simd(
  real32_t *result,
  const real32_t *image, const real32_t *kernel,
  int input_height, int input_width, int input_channels,
  int stride_height, int stride_width, int output_channels,
